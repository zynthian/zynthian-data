...
this forum soundset 3 folder contains the following files:


* usersoundset3.mid
  This file contains the new forum 3 soundset as a Standard Midi File. 


* key17demosong.mid
  A demo song for the User Sound Set 3 made by Matthew Davidson.
  Simply import it into your sequencer and play it back with a speed of 138 bpm
  and use Multi Program 21! Enjoy!


* usersoundset3.pdf
  This file contains information and the sound name list for the forum 3 soundset  as a PDF     
  (you have to install Acrobat Reader 3.0 or later).


 To avoid problems during the upload of the forum 3 soundset, we recommend
 ...
 - start the transmission of the new forum 3 soundset 


To dump the Sound Set to the Microwave II (or XT / XTk):


1. Connect the MIDI Out of the sender with the MIDI In of the Microwave II/XT/XTk.
2. Set the Device ID of the Microwave II/XT/XTk to 0. You can find this setting in the Global menu.
...
Now have fun with the new forum 3 soundset !


Your Waldorf Electronics Team including Boele Gerkes (who made this soundset possible)
and now enjoys his Q+ !



(c) 2002-09 Waldorf Electronics GmbH, Germany.
